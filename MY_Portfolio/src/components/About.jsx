            ...
            <div ref={textContainerRef} className="flex flex-col justify-center space-y-10">
              ...
              <div className="overflow-hidden">
                <h2 className="stagger-reveal text-5xl md:text-6xl font-bold tracking-tighter text-white font-sans leading-tight">
                  About <br />
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-purple-500 font-serif italic pr-4">
                    Me
                  </span>
                </h2>
              </div>
              ...
              <div className="overflow-hidden">
                <p className="stagger-reveal text-lg md:text-xl text-gray-400 font-light leading-relaxed max-w-xl">
                  I'm <span className="text-white font-semibold">Agyey Tiwari</span>, an MCA student specializing in
                  <span className="text-red-500"> Artificial Intelligence</span>. I have hands-on experience in
                  Python, Django, Machine Learning, Deep Learning, Computer Vision and modern AI technologies.
                  I enjoy building intelligent applications that solve real-world problems, from AI-powered facial
                  recognition systems to scalable web applications. My objective is to become an AI Engineer who
                  develops innovative, reliable and impactful solutions through Artificial Intelligence.
                </p>
              </div>
