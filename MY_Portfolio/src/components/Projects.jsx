...
import imgMan from '../assets/man/Agyey.jpeg';
...
const MISSIONS = [
  {
    ...
    description:
      'Developed an AI-powered attendance system using Python, OpenCV and Deep Learning for real-time face detection and recognition. The system automates attendance with high accuracy while ensuring fast and reliable identification.',
    tech: [
      'Python',
      'OpenCV',
      'TensorFlow',
    ...
    image: imgSpiderman,
    link: 'https://github.com/yourusername/facial-recognition-attendance',
...

  {
    ...
    description:
      'Designed and developed a responsive pharmacy management platform using Django. It includes secure authentication, medicine management, online ordering and an intuitive user interface.',
    tech: [
      'Python',
      'Django',
      'SQL',
    ...
    image: imgMan,
    link: 'https://github.com/yourusername/online-pharmacy',
...

  {
    ...
    description:
      'Built a responsive resume builder that allows users to generate professional resumes with customizable templates and modern UI while maintaining ATS-friendly formatting.',
    tech: [
      'React',
      'JavaScript',
      'Tailwind CSS',
        ...
        <div ref={headerRef} className="mb-16 md:mb-24 flex flex-col md:flex-row md:items-end justify-between border-b border-white/10 pb-8">
          <div className="max-w-2xl">
            <h2 className="text-4xl md:text-5xl lg:text-[4.5rem] font-bold tracking-tighter text-white font-sans leading-none drop-shadow-lg mb-4">
              Featured <span className="font-serif italic font-light opacity-80 text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-white pr-2">Project</span>
            </h2>
          </div>
          <p className="text-gray-400 font-light tracking-wide text-base md:text-lg max-w-sm mt-6 md:mt-0 leading-relaxed md:text-right">
            A selection of AI, Machine Learning and Full Stack projects built to solve real-world problems with scalable and modern technologies.
          </p>
        </div>
